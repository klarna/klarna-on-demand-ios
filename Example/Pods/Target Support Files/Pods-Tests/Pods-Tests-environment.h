...
// InApp
#define COCOAPODS_POD_AVAILABLE_InApp
#define COCOAPODS_VERSION_MAJOR_InApp 0
#define COCOAPODS_VERSION_MINOR_InApp 1
#define COCOAPODS_VERSION_PATCH_InApp 0
